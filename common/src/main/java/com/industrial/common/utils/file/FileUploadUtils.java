package com.industrial.common.utils.file;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = IndustrialConfig.getProfile();
    ...
    {
        int dirLastIndex = IndustrialConfig.getProfile().length() + 1;
